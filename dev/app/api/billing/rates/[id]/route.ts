...
import { updateBillingRate } from '@/lib/finance/billing-service'
...
export async function PATCH(
  ...
  try {
    ...
    const rate = await updateBillingRate(id, organizationId, {
      ...updateData,
    ...
    return NextResponse.json({ error: 'Failed to update billing rate' }, { status: 500 })
  }
}
