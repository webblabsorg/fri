...
Help us design a comprehensive, high-end AI platform tailored specifically for legal professionals. Below is the full product structure and flow, including all main pages, inner pages, and the user experience from the marketing site through onboarding and into the application.

---

## **Platform Overview**

Our platform will be the leading AI workspace for legal professionals, offering **240 specialized AI tools**—far more than competitors, who typically provide only 5–20 tools. Because of this, the platform must feel powerful, premium, and highly organized, while remaining intuitive to navigate.
...
4. **Admin Dashboard**
5. **Legal + Support Inner Pages**
   (Privacy Policy, Terms of Service, Cookie Policy, Contact, Support Center, Submit a Ticket, etc.)

A separate document will be created later specifically for the **User Dashboard**, but this prompt should still outline its structure at a high level.

---

## **Homepage / Landing Page Requirements**

The homepage will act as the main promotional and marketing page. It should:

* Feature a hero section promoting the platform as the #1 AI suite for legal professionals.
* Clearly highlight the value: **240 AI tools**, categorized and uniquely crafted for legal workflows.
* Include standard marketing sections such as:

  * Features overview
  * Tool categories showcase
  * Pricing preview
  * Testimonials
  * Security & compliance (important for legal professionals)
  * Footer with all legal and support links

At the **top-right corner**, include:
...
When the user clicks **Pricing**, show all pricing tiers, including:

* **Free plan**
* One or more premium tiers for legal teams and firms
* Features comparison table

### Start for Free Flow

When the user clicks **Start for Free**, direct them to the **Sign-up page**.
After successful registration, the user is redirected to:

**app.domainname.com**
→ This is the main app dashboard.

---

## **User Dashboard Structure**

The dashboard is the core of the product. It will display all **240 AI tools** with intelligent navigation and filtering.

### Left Navigation Menu

A fixed sidebar will include:

1. **All AI Tools**
2. **AI Tool Categories**

   * Each category expands/collapses.
   * Categories contain their respective tools.
   * If a category contains more than 5 tools, include a **“View More”** link to show all tools in the center panel.
3. **User Settings**
...
* Displays AI tools based on category or “All Tools.”
* Tools arranged in a **4-column layout**, supporting:

  * 6–12 rows per page
  * Pagination or infinite scroll
* Includes:

  * Filters (e.g., category selector, search bar, favorites)
  * Sorting options (e.g., most used, newest, alphabetical)
  * Quick-view tool cards

### Advanced Features (to differentiate from competitors)

* Smart search powered by AI
* Recommended AI tools based on user behavior
* Pin/favorite tools
* Workspace or folder system for organizing AI workflows
* Collaboration features for law firms or teams
...
* Content & tool categorization management
* System logs
* Announcement/broadcast manager

---

## **Inner Pages Required**

The platform must include standard legal and support pages:
...
* FAQ
* About / Company Info
* System Status Page (optional but recommended)

---

## **Task**

Using all of the details above, create a complete documentation set for:

1. **Landing Page + All Marketing Pages**
2. **Auth Pages**
3. **Admin Dashboard**
4. **All Inner Legal/Support Pages**

A separate, detailed document will be created later for the **User Dashboard**, but outline its structure in this prompt to maintain overall platform context.
...
Thanks — you’re right. I’ve added a full, production-ready **User Dashboard** document and integrated it into the overall platform specification. Below is a focussed, detailed spec for the **User Dashboard** you requested — ready to hand off to designers, PMs, or engineers.
